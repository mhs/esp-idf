...
CmdScanStart = _reflection.GeneratedProtocolMessageType(
    'CmdScanStart',
    (_message.Message,),
    {
...
RespScanStart = _reflection.GeneratedProtocolMessageType(
    'RespScanStart',
    (_message.Message,),
    {
...
CmdScanStatus = _reflection.GeneratedProtocolMessageType(
    'CmdScanStatus',
    (_message.Message,),
    {
...
RespScanStatus = _reflection.GeneratedProtocolMessageType(
    'RespScanStatus',
    (_message.Message,),
    {
...
CmdScanResult = _reflection.GeneratedProtocolMessageType(
    'CmdScanResult',
    (_message.Message,),
    {
...
WiFiScanResult = _reflection.GeneratedProtocolMessageType(
    'WiFiScanResult',
    (_message.Message,),
    {
...
RespScanResult = _reflection.GeneratedProtocolMessageType(
    'RespScanResult',
    (_message.Message,),
    {
...
WiFiScanPayload = _reflection.GeneratedProtocolMessageType(
    'WiFiScanPayload',
    (_message.Message,),
    {
